...
class TestReNotation(unittest.TestCase):
    def test_infix_to_postfix(self):
        ...
        self.assertEqual("+*a*b", infix_to_prefix("a*+b*"))
        self.assertEqual("a.b", infix_to_prefix("a b"))
        self.assertEqual("a.b.c.d.e.f", infix_to_prefix("a b     c     d     e    f"))
        self.assertEqual("+a.bc.d", infix_to_prefix("ab + cd"))
        self.assertEqual("+a.b.e+c.df.g", infix_to_prefix("abe + cd + fg"))
        self.assertEqual("+a.b.e+c.df.g.h.i", infix_to_prefix("abe + cd + (fg)(hi)"))
        self.assertEqual("+a.b.e+c.df.g.+h.ij.j", infix_to_prefix("abe + cd + (fg)(hi + jj)"))
        self.assertEqual("+*a.b.e+c.df.g.+h.ij.j", infix_to_prefix("(abe)* + cd + (fg)(hi + jj)"))
        ...
        self.assertEqual("+*a.b.e+*c.df.g.+h.ij.j", infix_to_prefix("(abe)* + c*d + (fg)(hi + jj)"))
        self.assertEqual("+*a.b.e+c.*df.g.+h.ij.j", infix_to_prefix("(abe)* + cd* + (fg)(hi + jj)"))
        self.assertEqual("+*a.b.e+*c.df.g.+h.ij.j", infix_to_prefix("(abe)* + (c)*d + (fg)(hi + jj)"))
        self.assertEqual("c.*d", infix_to_prefix("c(d)*"))
        self.assertEqual("*d.c", infix_to_prefix("(d)*c"))
        self.assertEqual("b.*d.c", infix_to_prefix("b.(d)*c"))
        self.assertEqual("+*a.b.e+c.*df.g.+h.ij.j", infix_to_prefix("(abe)* + c(d)* + (fg)(hi + jj)"))
        self.assertEqual("+*a.b.e+*c.*df.g.+h.ij.j", infix_to_prefix("(abe)* + c*d* + (fg)(hi + jj)"))
        self.assertEqual("+*a.b.e+*c.*df.g.+h.ij.j", infix_to_prefix("(abe)* + (c)*(d)* + (fg)(hi + jj)"))
        self.assertEqual("+*a.b.e+*c.x.*d.yf.g.+h.ij.j", infix_to_prefix("(abe)* + (cx)*(dy)* + (fg)(hi + jj)"))
        self.assertEqual("+*a.b.e+*c.x.*d.yf.g.+h.ij.j.*+y.yx.x", infix_to_prefix("(abe)* + (cx)*(dy)* + (fg)(hi + jj)(yy + xx)*"))
